    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**Lütfen Grubun Görüntülü Sohbetini Başlatıp Öyle deneyin.**\n\nSorun devam ederse /restart Atıp Tekrar Deneyin."
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**Asistan Zaten Sesli Sohbette Görünüyor.**\nHata Devam ediyorsa /restart Yazıp Tekrar Deneyin.\nSesli Sohbeti Sonlaandırıp Tekrar Açınız?"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**❌ HATA ❌**\nLütfen asisstan hesabının banlı olmadığınan emin olun. Sorun devam Ederse /restart komutunu kullanın Ve ya bot yetkililerine bildirin."
            )
